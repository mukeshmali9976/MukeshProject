...
public class ProductitemListModel {
    ...
    public String getStock_quentity() {
        return stock_quentity;
    }

    public void setStock_quentity(String stock_quentity) {
    ...
    public void setBulkproduct(String bulkproduct) {
    ...
    public String getProduct_vendor_price() {
        return product_vendor_price;
    }

    public void setProduct_vendor_price(String product_vendor_price) {
        this.product_vendor_price = product_vendor_price;
    }
}
