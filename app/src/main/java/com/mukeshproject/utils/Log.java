...
public class Log {
    ...
    /**
     * @param callDepth Normally 2 (or 1 if directly used). This method is calles from a util class like a Log class you dont want the name of the log method but the method
    ...
    private static LogInterface getInstance() {
        if (instance == null) instance = newDefaultAndroidLog();
        return instance;
    }
